...
var Input = forwardRef(function (_a, ref) {
    var className = _a.className, type = _a.type, disabled = _a.disabled, state = _a.state, feedbackText = _a.feedbackText, id = _a.id, name = _a.name, onChange = _a.onChange, onClick = _a.onClick, onBlur = _a.onBlur, value = _a.value, readonly = _a.readonly, showState = _a.showState, showErrorOnly = _a.showErrorOnly, customStyle = _a.customStyle, restProps = __rest(_a, ["className", "type", "disabled", "state", "feedbackText", "id", "name", "onChange", "onClick", "onBlur", "value", "readonly", "showState", "showErrorOnly", "customStyle"]);
