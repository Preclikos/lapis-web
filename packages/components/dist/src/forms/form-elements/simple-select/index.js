...
var Select = forwardRef(function (_a, ref) {
    var className = _a.className, disabled = _a.disabled, state = _a.state, feedbackText = _a.feedbackText, id = _a.id, name = _a.name, value = _a.value, onChange = _a.onChange, onBlur = _a.onBlur, onClick = _a.onClick, readonly = _a.readonly, children = _a.children, showState = _a.showState, showErrorOnly = _a.showErrorOnly, customStyle = _a.customStyle, restProps = __rest(_a, ["className", "disabled", "state", "feedbackText", "id", "name", "value", "onChange", "onBlur", "onClick", "readonly", "children", "showState", "showErrorOnly", "customStyle"]);
    ...
    return (_jsxs(_Fragment, { children: [_jsx("select", __assign({ className: clsx("custom-select", defaultClass, focusClass, readOnlyAndDisabledClass, readOnlyFocusClass, successClass, warningClass, errorClass, focusBorderClass, noFocusClass, className), ref: ref, id: id, name: name, value: value, onChange: onChange, onClick: onClick, onBlur: onBlur, disabled: disabled }, restProps, { children: children }), void 0), feedbackText && showState && (_jsx(Feedback, __assign({ state: state, showErrorOnly: showErrorOnly }, { children: feedbackText }), void 0))] }, void 0));
});
