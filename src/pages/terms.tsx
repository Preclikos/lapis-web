    ...
    <Layout>
      ...
      <Card>
        <CardBody>
          ...
          <h1>General Terms</h1>
          <p>
            By accessing and placing an order with Lapis, you confirm that you
          ...
          <p>
            ...
            or the inability to use, the materials on this site, even if Lapis
          ...
          <p>
            Lapis will not be responsible for any outcome that may occur during
          ...
          <h1>License</h1>
          <p>
            Lapis grants you a revocable, non-exclusive, non-transferable,
          ...
          <p>
            ...
            the Lapis website and the services accessible from the Lapis website
            (which are collectively referred to in these Terms &amp; Conditions
            as the &apos;Lapis Service&apos;).
          </p>
          <p>
            ...
            Lapis Service. In these Terms &amp; Conditions, &apos;you&apos;
          ...
          <ul>
            ...
            <li>
              ...
              “our,” it refers to Lapis, that is responsible for your
            ...
            <li>
              ...
              computer or any other device that can be used to visit Lapis and
              use the services.
            </li>
            <li>
              Service: refers to the service provided by Lapis as described in
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of Lapis or its affiliates,
              partners, suppliers or the licensors of the website/app.
            </li>
          </ul>
          <h1>Return and Refund Policy</h1>
          <p>
            Thanks for shopping at Lapis. We appreciate the fact that you like
          ...
          <p>
            ...
            apply to transactions at Lapis. We’ll be as brief as our attorneys
            will allow. The main thing to remember is that by placing an order
            or making a purchase at Lapis, you agree to the terms along with
          ...
          <p>
            ...
            (collectively, &apos;Suggestions&apos;) provided by you to Lapis
            with respect to the website/app shall remain the sole and exclusive
            property of Lapis.
          </p>
          <p>
            Lapis shall be free to use, copy, modify, publish, or redistribute
          ...
          <p>
            ...
            controlled by Lapis. We are not responsible for the content,
          ...
          <h1>Cookies</h1>
          <p>
            Lapis uses &apos;Cookies&apos; to identify the areas of our website
            ...
            to enhance the performance and functionality of our website/app but
            ...
            the website/app as we would not be able to remember that you had
            logged in previously. Most web browsers can be set to disable the
            use of Cookies. However, if you disable Cookies, you may not be able
            to access functionality on our website correctly or at all. We never
          ...
          <p>
            ...
            Service) to you or to users generally at Lapis’s sole discretion,
            without prior notice to you. You may stop using the Service at any
            time. You do not need to specifically inform Lapis when you stop
            using the Service. You acknowledge and agree that if Lapis disables
          ...
          <p>
            Lapis reserves the right to modify, suspend or discontinue,
            temporarily or permanently, the website/app or any service to which
            it connects, with or without notice and without liability to you.
          </p>

          <h1>Updates to Our website/app</h1>
          <p>
            Lapis may from time to time provide enhancements or improvements to
          ...
          <p>
            ...
            of the website/app. You agree that Lapis has no obligation to (i)
            provide any Updates, or (ii) continue to provide or enable any
            particular features and/or functionalities of the website/app to
            you.
          </p>
          <p>
            You further agree that all Updates will be (i) deemed to constitute
            an integral part of the website/app, and (ii) subject to the terms
          ...
          <p>
            You acknowledge and agree that Lapis shall not be responsible for
            any Third-Party Services, including their accuracy, completeness,
            timeliness, validity, copyright compliance, legality, decency,
            quality or any other aspect thereof. Lapis does not assume and shall
          ...
          <p>
            Lapis may, in its sole discretion, at any time and for any or no
          ...
          <p>
            ...
            Lapis, in the event that you fail to comply with any provision of
          ...
          <p>
            Termination of this Agreement will not limit any of Lapis&apos;s
          ...
          <p>
            ...
            website/app; (b) violation of this Agreement or any law or
          ...
          <p>
            ...
            Lapis, on its own behalf and on behalf of its affiliates and its and
            their respective licensors and service providers, expressly
            disclaims all warranties, whether express, implied, statutory or
            otherwise, with respect to the website/app, including all implied
            ...
            Without limitation to the foregoing, Lapis provides no warranty or
          ...
          <p>
            ...
            website/app, or the information, content, and materials or products
            included thereon; (ii) that the website/app will be uninterrupted or
            error-free; (iii) as to the accuracy, reliability, or currency of
            any information or content provided through the website/app; or (iv)
            that the website/app, its servers, the content, or e-mails sent from
            or on behalf of Lapis are free of viruses, scripts, trojan horses,
          ...
          <p>
            ...
            liability of Lapis and any of its suppliers under any provision of
          ...
          <p>
            ...
            Lapis or its suppliers be liable for any special, incidental,
            ...
            or inability to use the website/app, third-party software and/or
            third-party hardware used with the website/app, or otherwise in
            connection with any provision of this Agreement), even if Lapis or
          ...
          <p>
            ...
            notices published by Lapis on the Services, shall constitute the
            entire agreement between you and Lapis concerning the Services. If
            ...
            such term or any other term, and Lapis&apos;s failure to assert any
            right or provision under this Agreement shall not constitute a
            waiver of such right or provision. YOU AND Lapis AGREE THAT ANY
          ...
          <p>
            Lapis reserves the right, at its sole discretion, to modify or
          ...
          <p>
            ...
            when you use or purchase other Lapis&apos;s services, which Lapis
          ...
          <p>
            ...
            arrangement thereof), are owned by Lapis, its licensors or other
            providers of such material and are protected by CZ and international
            ...
            or in part, without the express prior written permission of Lapis,
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Lapis&apos;s
            INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
            action, or other controversy between you and Lapis concerning the
          ...
          <p>
            In the event of a dispute, you or Lapis must give the other a Notice
            ...
            Lapis will send any Notice of Dispute to you by mail to your address
            if we have it, or otherwise to your email address. You and Lapis
            ...
            After sixty (60) days, you or Lapis may commence arbitration.
          </p>

          <h1>Binding Arbitration</h1>
          <p>
            If you and Lapis don’t resolve any dispute by informal negotiation,
          ...
          <p>
            ...
            property of Lapis without any compensation or credit to you
            whatsoever. Lapis and its affiliates shall have no obligations with
          ...
          <h1>Promotions</h1>
          <p>
            Lapis may, from time to time, include contests, promotions,
          ...
          <p>
            ...
            and signed by an authorized representative of Lapis. Lapis will be
            ...
            breach or anticipatory breach by you. Lapis operates and controls
            the Lapis Service from its offices in CZ. The Service is not
            ...
            to access the Lapis Service from other locations do so on their own
            ...
            &amp; Conditions (which include and incorporate the Lapis Privacy
            Policy) contains the entire understanding, and supersedes all prior
            understandings, between you and Lapis concerning its subject matter,
          ...
          <h1>Disclaimer</h1>
          <p>
            Lapis is not responsible for any content, code or any other
            imprecision.
          </p>
          ...
          <p>
            The Lapis Service and its contents are provided &apos;as is&apos;
            and &apos;as available&apos; without any warranty or representations
            of any kind, whether express or implied. Lapis is a distributor and
            not a publisher of the content supplied by third parties; as such,
            Lapis exercises no editorial control over such content and makes no
            warranty or representation as to the accuracy, reliability or
            currency of any information, content, service or merchandise
            provided through or accessible via the Lapis Service. Without
            limiting the foregoing, Lapis specifically disclaims all warranties
            and representations in any content transmitted on or in connection
            with the Lapis Service or on sites that may appear as links on the
            Lapis Service, or in the products provided as a part of, or
            otherwise in connection with, the Lapis Service, including without
            ...
            oral advice or written information given by Lapis or any of its
            ...
            change without notice. Without limiting the foregoing, Lapis does
            not warrant that the Lapis Service will be uninterrupted,
            uncorrupted, timely, or error-free.
          </p>
          <h1>Account deletion</h1>
          <p>
            If u want delete your account u can send Deletion Request to
            mail:&nbsp;
