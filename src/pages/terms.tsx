...
const TermsAndConditions = () => {
  ...
  return (
    <Layout>
      ...
      <h1>General Terms</h1>
      <p>
        By accessing and placing an order with Lapis, you confirm that you are
      ...
      <p>
        Under no circumstances shall Lapis team be liable for any direct,
        ...
        inability to use, the materials on this site, even if Lapis team or an
      ...
      <p>
        Lapis will not be responsible for any outcome that may occur during the
      ...
      <h1>License</h1>
      <p>
        Lapis grants you a revocable, non-exclusive, non-transferable, limited
        license to download, install and use the website/app strictly in
        accordance with the terms of this Agreement.
      </p>
      <p>
        These Terms &amp; Conditions are a contract between you and Lapis
        (referred to in these Terms &amp; Conditions as &apos;Lapis&apos;,
        &apos;us&apos;, &apos;we&apos; or &apos;our&apos;), the provider of the
        Lapis website and the services accessible from the Lapis website (which
      ...
      <p>
        ...
        not agree to these Terms &amp; Conditions, please do not use the Lapis
        Service. In these Terms &amp; Conditions, &apos;you&apos; refers both to
        you as an individual and to the entity you represent. If you violate any
      ...
      <ul>
        ...
        <li>
          ...
          refers to Lapis, that is responsible for your information under this
          Terms &amp; Conditions.
        </li>
        <li>
          Country: where Lapis or the owners/founders of Lapis are based, in
          this case is CZ
        </li>
        <li>
          Device: any internet connected device such as a phone, tablet,
          computer or any other device that can be used to visit Lapis and use
          the services.
        </li>
        <li>
          Service: refers to the service provided by Lapis as described in the
        ...
        <li>
          Website: Lapis&apos;s site, which can be accessed via this URL:
          https://lapis.report
        </li>
        <li>
          You: a person or entity that is registered with Lapis to use the
          Services.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          of copyright or trademark) of Lapis or its affiliates, partners,
          suppliers or the licensors of the website/app.
        </li>
      </ul>
      <h1>Return and Refund Policy</h1>
      <p>
        Thanks for shopping at Lapis. We appreciate the fact that you like to
      ...
      <p>
        ...
        apply to transactions at Lapis. We’ll be as brief as our attorneys will
        allow. The main thing to remember is that by placing an order or making
        a purchase at Lapis, you agree to the terms along with
        Lapis&apos;s Privacy Policy.
      </p>
      <p>
      ...
      <p>
        ...
        (collectively, &apos;Suggestions&apos;) provided by you to Lapis with
        respect to the website/app shall remain the sole and exclusive property
        of Lapis.
      </p>
      <p>
        Lapis shall be free to use, copy, modify, publish, or redistribute the
      ...
      <p>
        ...
        may contain links to other websites not operated or controlled by Lapis.
        ...
        &amp; Conditions are no longer in effect. Your browsing and interaction
        on any other website, including those that have a link on our platform,
        is subject to that website’s own rules and policies. Such third parties
        may use their own cookies or other methods to collect information about
        you.
      </p>

      <h1>Cookies</h1>
      <p>
        Lapis uses &apos;Cookies&apos; to identify the areas of our website that
        ...
        the performance and functionality of our website/app but are
      ...
      <p>
        You acknowledge and agree that Lapis may stop (permanently or
        temporarily) providing the Service (or any features within the Service)
        to you or to users generally at Lapis’s sole discretion, without prior
        notice to you. You may stop using the Service at any time. You do not
        need to specifically inform Lapis when you stop using the Service. You
        acknowledge and agree that if Lapis disables access to your account, you
      ...
      <p>
        Lapis reserves the right to modify, suspend or discontinue, temporarily
        or permanently, the website/app or any service to which it connects,
        with or without notice and without liability to you.
      </p>

      <h1>Updates to Our website/app</h1>
      <p>
        Lapis may from time to time provide enhancements or improvements to the
        features/ functionality of the website/app, which may include patches,
      ...
      <p>
        ...
        the website/app. You agree that Lapis has no obligation to (i) provide
      ...
      <p>
        You acknowledge and agree that Lapis shall not be responsible for any
        ...
        or any other aspect thereof. Lapis does not assume and shall not have
      ...
      <p>
        This Agreement shall remain in effect until terminated by you or Lapis.
      </p>
      <p>
        Lapis may, in its sole discretion, at any time and for any or no reason,
      ...
      <p>
        ...
        Lapis, in the event that you fail to comply with any provision of this
      ...
      <p>
        Termination of this Agreement will not limit any of Lapis&apos;s rights
      ...
      <p>
        You agree to indemnify and hold Lapis and its parents, subsidiaries,
        ...
        fees, due to or arising out of your: (a) use of the website/app; (b)
        violation of this Agreement or any law or regulation; or (c) violation
      ...
      <p>
        ...
        kind. To the maximum extent permitted under applicable law, Lapis, on
        ...
        respect to the website/app, including all implied warranties of
        merchantability, fitness for a particular purpose, title and
        non-infringement, and warranties that may arise out of course of
        dealing, course of performance, usage or trade practice. Without
        limitation to the foregoing, Lapis provides no warranty or undertaking,
      ...
      <p>
        Without limiting the foregoing, neither Lapis nor any Lapis&apos;s
        ...
        servers, the content, or e-mails sent from or on behalf of Lapis are
      ...
      <p>
        ...
        of Lapis and any of its suppliers under any provision of this Agreement
      ...
      <p>
        ...
        Lapis or its suppliers be liable for any special, incidental, indirect,
        ...
        Agreement), even if Lapis or any supplier has been advised of the
      ...
      <p>
        ...
        notices published by Lapis on the Services, shall constitute the entire
        agreement between you and Lapis concerning the Services. If any
        ...
        term, and Lapis&apos;s failure to assert any right or provision under
        this Agreement shall not constitute a waiver of such right or provision.
        YOU AND Lapis AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED
      ...
      <p>
        Lapis reserves the right, at its sole discretion, to modify or replace
      ...
      <p>
        ...
        not agree to the new terms, you are no longer authorized to use Lapis.
      </p>

      <h1>Entire Agreement</h1>
      <p>
        The Agreement constitutes the entire agreement between you and Lapis
        regarding your use of the website/app and supersedes all prior and
        contemporaneous written or oral agreements between you and Lapis.
      </p>
      <p>
        You may be subject to additional terms and conditions that apply when
        you use or purchase other Lapis&apos;s services, which Lapis will
      ...
      <p>
        ...
        thereof), are owned by Lapis, its licensors or other providers of such
        material and are protected by CZ and international copyright, trademark,
        ...
        express prior written permission of Lapis, unless and except as is
      ...
      <p>
        ...
        ENFORCEMENT OR VALIDITY OF YOUR OR Lapis&apos;s INTELLECTUAL PROPERTY
        RIGHTS. The term “dispute” means any dispute, action, or other
        controversy between you and Lapis concerning the Services or this
      ...
      <p>
        In the event of a dispute, you or Lapis must give the other a Notice of
        ...
        <a
          ...
          data-cfemail="a8c9ccc5c1c6e8c4c9d8c1db86dacdd8c7dadc86"
        >
          [email&amp;#160;protected]
        </a>{' '}
        Lapis will send any Notice of Dispute to you by mail to your address if
        we have it, or otherwise to your email address. You and Lapis will
        ...
        days, you or Lapis may commence arbitration.
      </p>

      <h1>Binding Arbitration</h1>
      <p>
        If you and Lapis don’t resolve any dispute by informal negotiation, any
      ...
      <p>
        ...
        and will become the sole property of Lapis without any compensation or
        credit to you whatsoever. Lapis and its affiliates shall have no
      ...
      <h1>Promotions</h1>
      <p>
        Lapis may, from time to time, include contests, promotions, sweepstakes,
      ...
      <p>
        ...
        representative of Lapis. Lapis will be entitled to injunctive or other
        equitable relief (without the obligations of posting any bond or surety)
        in the event of any breach or anticipatory breach by you. Lapis operates
        and controls the Lapis Service from its offices in CZ. The Service is
        ...
        the Lapis Service from other locations do so on their own initiative and
        ...
        include and incorporate the Lapis Privacy Policy) contains the entire
        understanding, and supersedes all prior understandings, between you and
        Lapis concerning its subject matter, and cannot be changed or modified
      ...
      <h1>Disclaimer</h1>
      <p>
        Lapis is not responsible for any content, code or any other imprecision.
      </p>
      <p>Lapis does not provide warranties or guarantees.</p>
      <p>
        In no event shall Lapis be liable for any special, direct, indirect,
      ...
      <p>
        The Lapis Service and its contents are provided &apos;as is&apos; and
        &apos;as available&apos; without any warranty or representations of any
        kind, whether express or implied. Lapis is a distributor and not a
        publisher of the content supplied by third parties; as such, Lapis
        ...
        accessible via the Lapis Service. Without limiting the foregoing, Lapis
        specifically disclaims all warranties and representations in any content
        transmitted on or in connection with the Lapis Service or on sites that
        may appear as links on the Lapis Service, or in the products provided as
        a part of, or otherwise in connection with, the Lapis Service, including
        without limitation any warranties of merchantability, fitness for a
        particular purpose or non-infringement of third party rights. No oral
        advice or written information given by Lapis or any of its affiliates,
